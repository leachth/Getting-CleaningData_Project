...
This data set was produced form and experiment where subjects were asked to go through a 
...
More detailed information on the experiment and data can be found here: 
http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones

The run_analysis script merges the testing and training data sets and creates a  
table that summarized the average and standard deviations for all acceleration and angular 
velocity measurements reported in the experiment for each subject and each activity. 
...
The acceleration and angular velocity variables are described using the format 
"variable - summary()-A" where variable represents the acceleration of angular velocity 
variable measured by the experimenters, summary is either a mean or a standard deviation, written as mean or std
and the A represents the dimension, either X,Y or Z.
